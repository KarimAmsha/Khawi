...
class Router: ObservableObject {
    ...
    struct State {
        ...
        var presentingToastPopup: ViewSpec? = nil
        var isPresented: Binding<ViewSpec?>

        var isPresenting: Bool {
            presentingSheet != nil || presentingFullScreen != nil || presentingModal != nil || presentingToastPopup != nil
        }
    }
...
//    }
    ...
    func view(spec: ViewSpec, route: Route, appState: AppState, settings: UserSettings) -> AnyView {
        AnyView(EmptyView())
    }
}
...
extension Router {
    ...
    func presentToastPopup(_ viewSpec: ViewSpec) {
        state.presentingToastPopup = viewSpec
    }
    ...
    func dismiss() {
        ...
        } else if state.presentingToastPopup != nil {
            state.presentingToastPopup = nil
...
extension Router {
    ...
    var presentingToastPopup: Binding<ViewSpec?> {
        binding(keyPath: \.presentingToastPopup)
    }
...
private extension Router {
    ...
    func binding(keyPath: WritableKeyPath<State, ViewSpec?>) -> Binding<Bool> {
        Binding(
