//
//  SuccessJoiningRequestView.swift
//  Khawi
//
...
struct SuccessJoiningRequestView: View {
    ...
    var body: some View {
        VStack(alignment: .center, spacing: 24) {
            ...
            Text(LocalizedStringKey.joiningSuccess)
...
#Preview {
    SuccessJoiningRequestView(router: MainRouter(isPresented: .constant(.main)))
}
