//
//  DeliveryRequestSuccessView.swift
//  Khawi
//
...
struct DeliveryRequestSuccessView: View {
    ...
    var body: some View {
        VStack(alignment: .center, spacing: 24) {
            ...
            Button {
                router.dismiss()
                router.presentViewSpec(viewSpec: .deliveryRequestOrderDetailsView(orderID))
            } label: {
...
#Preview {
    DeliveryRequestSuccessView(orderID: "", message: "", router: MainRouter(isPresented: .constant(.main)))
}
